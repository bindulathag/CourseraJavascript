...
function buildAndShowHomeHTML (categories) {
    ...
    $ajaxUtils.sendGetRequest(
        ...
        function (homeHtmlUrl) {
          ...
          //console.log("homeHtmlUrl="+homeHtmlUrl +"/ncategories="+categories);
        ...
        // var chosenCategoryShortName = ....
          ...
          //   function (homeHtmlUrl) {
              ...
              //switchMenuToActive();
              //console.log("After switchMenuToActive");
        ...
        //
        var homeHtmlToInsertIntoMainPage = insertProperty(homeHtmlUrl,"randomCategoryShortName","'"+randomCategoryShortName+"'");
